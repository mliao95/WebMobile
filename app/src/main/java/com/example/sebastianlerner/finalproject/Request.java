...
public class Request {
    ...
    public Request(String location1, String location2, String date1, int riders1, boolean driving1, int time1){
        this.name = "Untitled";
    ...
    public String toString() {
        if(this.driving == true){
            ...
            return  "Requesting ride from " + this.startLocation + " to " + this.endLocation + " with " +  this.riders + " riders on " + this.month + "/" + this.day + "/" + this.year + " at " + this.time;
        }
